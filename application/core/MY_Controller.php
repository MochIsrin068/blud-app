...
class Fund_Controller extends User_Controller{
    public function __construct(){
      parent::__construct();
        if($this->session->userdata('group_id')!=10){
          $this->session->set_flashdata('alert', $this->alert->set_alert( Alert::DANGER, 'Anda tidak memiliki hak akses') );
          $this->ion_auth->logout();
...
class Spending_Controller extends User_Controller{
    public function __construct(){
      parent::__construct();
...
class Sac_Controller extends User_Controller{
    public function __construct(){
      parent::__construct();
...
class BludHead_Controller extends User_Controller{
    public function __construct(){
      parent::__construct();
...
class BpkadHead_Controller extends User_Controller{
    public function __construct(){
      parent::__construct();
