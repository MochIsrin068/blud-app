...
<table>
    ...
    <tr>
        <td style="width:33%;font-weight: bold"> Semester <?php echo $semester ?> </td>
...
<table border="1" padding="2" >
    ...
    <tr style="font-size:10px;text-align: center;  border-bottom:0.5px solid black" >
        <td style="width:5% ">No</td>
        <td style="width:15% ">Kode Rekening</td>
        <td style="width:25% ">Uraian</td>
        <td style="width:10% ">Jumlah Anggaran</td>
        <td style="width:10% ">Realisasi Semester Lalu (Rp)</td>
        <td style="width:10% ">Realisasi Semester Ini (Rp)</td>
        <td style="width:12% ">Realisasi Sampai Dengan Semester Ini (Rp)</td>
    ...
    <tr style="font-size:10px" >
        ...
        <?php foreach( $header as $key => $value ):
                ...
                if( $key=='account_description' || $key=='account_code'  )
                    echo '<td padding="10" height="20" style="text-align: left;padding:20px"  >';
                else
                    echo '<td padding="10" height="20" style="text-align: right;padding:20px"  >';
            ?>
                <?php 
                    $attr = "";
                    if( is_numeric( $row->$key ) && ( $key != 'phone' && $key != 'username'  && $key != 'account_code' ) )
