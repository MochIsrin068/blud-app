                                    ...
                                    <?php 
                                            switch( $value['type'] )
                                            {
                                                ...
                                                case "modal_form" :
                                                    ...
                                                    break;
                                                case "modal_form_blank" :
                                                        $value["data"] = $row;
                                                        $this->load->view('templates/actions/modal_form_blank', $value ); 
                                                    break;
                                                case "modal_form_confirm" :
                                                        $value["data"] = $row;
                                                        $this->load->view('templates/actions/modal_form_confirm', $value ); 
                                                    break;
