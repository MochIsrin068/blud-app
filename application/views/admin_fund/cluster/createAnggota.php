		...
		<div class="row clearfix">
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>
							<?php echo strtoupper("anggota")?>
						</h2>
					</div>
					<div class="body">
						<?php echo form_open( site_url( $parent_page."/create_aplicantly" ) ) ?>
						<input name='party_id' type='hidden' id='party_id' value="<?php echo $party_id?>"/>
						<input name='group4' type='hidden' id='group4' value="1"/>
						<input name='ketua_id' type='hidden' id='group4' value="<?php echo $ketua_id?>"/>
						<?php 
							echo $form_add_1 ;
							...
							echo "<input name='group4' type='radio' id='radio_7' value='2' class='radio-col-red'  />";
