				...
				<div class="card">
					<div class="header">
						...
						<ul class="header-dropdown m-r--5">
							<!-- <button href="<?php echo site_url($parent_page)?>"><button type="button" class="btn btn-warning" name="button">Kembali</button></a> -->
						</ul>
					</div>
					<div class="body">
						<div class="row clearfix">
				...
				<div class="card">
					<div class="header">
						...
						<!-- http://localhost/blud/fund/cluster/create_aplicants/39 -->
							<a href="<?php echo site_url('member/cluster/create_aplicants/'.$party_id.'/'.$user_id)?>" class="btn btn-sm btn-primary">Tambah</a>
