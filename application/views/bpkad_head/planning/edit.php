                        ...
                        <!--  -->
                            ...
                            <div class="">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody id="table_body" >
                                        <?php foreach( $budget_plans as $budget_plan ) : ?>
                                            <tr>
                                                <!--  -->
                                                <td>
                                                    <div class="row clearfix">
                                                        <div class="col-md-8">
                                                                <input  type="text" class="form-control"  name="account_name[]" value="<?php echo $budget_plan->account_code ?>"  />
                                                                <input style="display:none"  type="text" class="form-control"  name="account_id[]" value="<?php echo $budget_plan->account_id ?>"  />
                                                        </div>
                                                        <div class="col-md-4">
                                                            <?php echo $dropdown ?>                                                                
                                                        </div>
                                                ...
                                                <!--  -->
                                                <td>
                                                        <input  type="text" class="form-control"  name="_description[]" value="<?php echo $budget_plan->description ?>"  />
                                                </td>
                                                <td>
                                                        <input  type="text" class="form-control" min="0"  name="unit[]" value="<?php echo $budget_plan->unit ?>"  />
                                                </td>
                                                <td>
                                                        <input  type="number" class="form-control" min="0"  name="quantity[]" value="<?php echo $budget_plan->quantity ?>"  />
                                                </td>
                                                <td>
                                                        <input  type="number" class="form-control" min="0"  name="price[]" value="<?php echo $budget_plan->price ?>"  />
                                                </td>
                                                <td>
