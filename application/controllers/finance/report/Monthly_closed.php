...
class Monthly_closed extends Finance_Controller {
	...
	private $current_page = 'finance/report/monthly_closed/';
	...
	public function index()
	{
		...
		$this->data["block_header"] = "Tutup Buku Per Bulan";
		$this->data["header"] = "Tutup Buku Per Bulan";
	...
	public function detail_report( $bookkeeping_id )
	{
		...
		// $link["url"] = site_url( $this->current_page. "detail_report/".$bookkeeping_id."?pdf=true" );
		...
		$this->data[ "modal_form_confirm" ] = $url_print ;
